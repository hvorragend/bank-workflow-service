  ...
  return (
    <section>
      <header className="page-header">
        <p className="eyebrow mb-3">Admin · Übersicht</p>
        <h2 className="page-title">Konfigurations-Cockpit</h2>
        <p className="page-lead">
          Hier konfigurieren Sie sämtliche Stellschrauben des Bank Workflow Service
          über das UI — User, Rollen, Permissions, LDAP, SMTP, E-Mail-Templates,
          SLA-Eskalation und Audit. Lokale Dateien bleiben nur für Bootstrap-
      ...
      {error ? (
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          ...
          <Stat label="SMTP" value={data.smtp_enabled ? "an" : "aus"}
                hint={data.smtp_host || "—"} />
          <Stat label="SLA-Scheduler" value={data.scheduler_running ? "läuft" : "aus"} />
