      ...
      <header className="page-header flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
        <div>
          ...
          <p className="page-lead">
            ...
            ist eine System-Rolle und nicht loeschbar — sie haelt automatisch alle
          ...
          <table className="w-full text-[13px]">
            <thead>
              <tr className="text-left text-quiet">
                ...
                <th className="px-4 py-2 font-mono text-[11px] uppercase tracking-wider">Beschreibung</th>
                <th className="px-4 py-2 font-mono text-[11px] uppercase tracking-wider">Permissions</th>
                <th className="px-4 py-2 font-mono text-[11px] uppercase tracking-wider">System</th>
                <th />
              </tr>
            </thead>
