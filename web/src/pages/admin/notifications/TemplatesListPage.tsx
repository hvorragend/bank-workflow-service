          ...
          <table className="w-full text-[13px]">
            <thead>
              <tr className="text-left text-quiet">
                <th className="px-4 py-2 font-mono text-[11px] uppercase tracking-wider">Key</th>
                <th className="px-4 py-2 font-mono text-[11px] uppercase tracking-wider">Subject</th>
                <th className="px-4 py-2 font-mono text-[11px] uppercase tracking-wider">Geaendert</th>
                <th />
              </tr>
            </thead>
